...
abstract class $LikeModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, String like});
}
...
class _$LikeModelImpl implements _LikeModel {
  _$LikeModelImpl({required this.userId, required this.like});
  ...
  @override
  String toString() {
    return 'LikeModel(userId: $userId, like: $like)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userId, like);
...
abstract class _LikeModel implements LikeModel {
  factory _LikeModel(
      ...
      required final String like}) = _$LikeModelImpl;
